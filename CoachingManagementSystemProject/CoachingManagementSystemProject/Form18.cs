...
namespace CoachingManagementSystemProject
{
    public partial class Form18 : Form
    {
        ...
        {
            conn.Open();
            string sql = "SELECT id FROM StuDetails ";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string sql = "update studetails set fullname='" + fullname + "',phone=" + phone + " where id='" + id + "'";
                conn.Open();
                ...
                if (r > 0)
                {
                    MessageBox.Show("Updation Complete you id is:" + id);
                }
                else
                {
